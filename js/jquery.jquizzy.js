    ...
    $.fn.jquizzy = function (settings) {
        ...
        var defaults = {
			...
			resultComments: {
                ...
                excellent: '<img src="../img/bintang.png"/>'+'Excellent!',
                good: '<img src="../img/bintang.png"/>'+'Good!',
                average: 'img/share.png'+'Acceptable!',
                bad: 'img/share.png'+'Disappointing!',
                poor: 'img/share.png'+'Poor!',
                worst: 'img/share.png'+'Nada!'
            }
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            if (questionsIteratorIndex !== 0) {
                contentFob += '<div class="prev"><a class="nav-previous" href="#">Kembali</a></div>';
            }

            if (questionsIteratorIndex < config.questions.length - 1) {
                contentFob += '<div class="next"><a class="nav-next" href="#">Lanjut</a></div>';
            } else {
                contentFob += '<div class="next final"><a class="nav-show-result" href="#">Cek Hasil</a></div>';
            }
        ...
        superContainer.find('.final').click(function () {
            ...
            for (var i = 0, toLoopTill = results.length; i < toLoopTill; i++) {
				...
				resultSet += '<div class="result-row"> Soal No. ' + (i + 1) + (results[i] === true ? "<div class='correct'><span>Betul</span></div>" : "<div class='wrong'><span>Salah</span></div>");
